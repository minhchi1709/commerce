# Generated by Django 5.0 on 2024-01-04 18:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='have', to=settings.AUTH_USER_MODEL)),
                ('sold_to', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, related_name='buy', to=settings.AUTH_USER_MODEL)),
